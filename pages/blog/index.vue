      ...
      <div class="flex">
        ...
        >
          <div class="rounded-lg bg-zinc-100">
            ...
            >
              <div
                class="w-full cover h-32 bg-cover bg-center rounded"
                v-if="data.image"
                :style="{
              ...
              <div class="p-8">
                <div
                  v-if="article.date"
                  class="monospace text-zinc-400 text-xs"
                >
                ...
                <div
                  class="text-zinc-600 text-sm font-light pt-4"
                ...
                <NuxtLink
                  :to="article._path"
                  class="text-primary-500 mt-4 block"
                >
                  Read post
                </NuxtLink>
              </div>
