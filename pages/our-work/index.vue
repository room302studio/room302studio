<template>
  <main class="pt-16 px-4 lg:px-20 xl:px-40 2xl:px-60">
    <ContentQuery path="/our-work/" :sort="{ date: -1 }" v-slot="{ data }">

      <div class="flex flex-wrap justify-center gap-4 lg:gap-10">
