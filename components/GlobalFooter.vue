<template>
  <div
    class="bg-stone-900 text-stone-50 dark:bg-stone-100 dark:text-stone-800 py-8"
  >
    <div class="my-12 py-6 lg:py-24 px-16 lg:px-12">
      ...
      <div
        class="flex flex-wrap justify-between mt-8 lg:mt-20 text-stone-400 text-sm"
      >
        <div class="callout-section-item my-4 md:w-1/3">
          <div>
            <h4
              class="text-lg leading-tight mb-4 text-stone-300 dark:text-stone-700 font-bold text-balance"
            >
        ...
        <div class="callout-section-item my-4 md:w-1/3">
          <div>
            <h4
              class="text-lg leading-tight mb-4 text-stone-300 dark:text-stone-700 font-bold text-balance"
            >
              <!-- New icon for innovation and experimentation -->
              <UIcon name="i-material-symbols-lab-research-rounded" />
              Fearless Experimentation
            </h4>
            <p class="pr-8">
              The future is for the bold. We embrace the unknown, pioneering new
              paths and designing new futures. We are at home exploring things
        ...
        <div class="callout-section-item my-4 md:w-1/3">
          <div>
            ...
            <p class="pr-8">
              Our online space emphasizes collaboration, where like-minded
              people can gather and turn their ideas into reality through the
    ...
    <div class="lg:py-18 px-16 lg:px-12 md:flex">
      <!-- quote -->
      <div
        class="w-full md:w-1/3 pr-4 md:pr-8 text-xl md:text-2xl font-light text-balance pb-16 md:py-0"
      >
      ...
      <div class="sitemap-section-item md:flex w-full">
        <div class="md:w-1/3 pb-10 md:py-0">
          ...
          <ul class="list-none">
            <li>
              <NuxtLink to="/contact/" class="text-primary-500"
                >Contact us</NuxtLink
              >
            </li>
            <li>
