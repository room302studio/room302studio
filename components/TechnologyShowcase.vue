  ...
  <section class="pad my-24 md:my-32">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
      ...
      <div v-if="showAndMore"
        ...
        <UIcon name="i-heroicons-beaker" class="text-3xl text-primary-500/70 mb-2 mx-auto" />
        <h4 class="font-medium text-stone-600 dark:text-stone-400">...and more!</h4>
      </div>
    </div>
  </section>
</template>
...
const ceoTechnologies = [
  ...
  { name: 'Docker', icon: 'i-simple-icons-docker' },
  { name: 'GitHub', icon: 'i-simple-icons-github' },
  { name: 'Google BigQuery', icon: 'i-simple-icons-googlebigquery' },
